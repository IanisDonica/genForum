...
urlpatterns = [
    ...
    path('add-badge/<int:userid>', views.addbadge, name='add-badge'),
    path('revoke-badge/<int:userid>/<int:badgeid>', views.revokebadge, name='revoke-badge'),
    path('post-pinning/<str:type>/<int:postid>', views.postPining, name='post-pinning'),
    path('modify-badge disco/<int:badgeid>', views.modifybadge, name='modify-badge'),
