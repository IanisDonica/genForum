    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_duration', models.PositiveIntegerField(default=None, null=True)),
                ('task_id', models.CharField(blank=True, max_length=100)),
                ('badge_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.badgetype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
